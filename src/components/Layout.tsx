...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0F1116] relative flex flex-col">
      <LandingNav />
      <main className="flex-grow">{children}</main>

      {/* Footer */}
      <footer className="relative pt-20 pb-12 bg-[#0F1116] overflow-hidden text-white">
        {/* Blobs */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
              ...
              <ul className="space-y-3">
                <li>
                  <button
                    ...
                    className="text-gray-400 hover:text-gradient-blue-cyan focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 transition-colors duration-300"
                  >
                    About Us
                  </button>
                </li>
          ...
          <div className="border-t border-[#2f68b4]/20 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between space-y-5 md:space-y-0">
            <div className="flex space-x-6">
              <a
                href="https://twitter.com/payzio"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 rounded"
                aria-label="Twitter"
              >
                <svg
                  className="w-6 h-6"
